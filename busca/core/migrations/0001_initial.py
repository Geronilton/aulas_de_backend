# Generated by Django 4.2.4 on 2023-12-28 12:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publico', models.ManyToManyField(to='core.publico')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            ...
            options={
                'permissions': [('bibliotecario', 'Permissão do Usuário Bibliotecário'), ('coordenador', 'Permissão do Usuário Coordenador')],
            },
            managers=[
